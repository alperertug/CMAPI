    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CafeCustomers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CafeCustomers_Cafes_CafeId",
                        column: x => x.CafeId,
                        principalTable: "Cafes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CafeCustomers_Customers_CustomerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CafeCustomers_CafeId",
                table: "CafeCustomers",
                column: "CafeId");

            migrationBuilder.CreateIndex(
                name: "IX_CafeCustomers_CustomerId",
                table: "CafeCustomers",
                column: "CustomerId");
