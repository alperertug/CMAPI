    ...
    public partial class mig_1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CafeUsers", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OfferProduct", x => new { x.OffersId, x.ProductsId });
                    table.ForeignKey(
                        name: "FK_OfferProduct_Offers_OffersId",
                        column: x => x.OffersId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Category_CafeId",
                table: "Category",
                column: "CafeId");

            migrationBuilder.CreateIndex(
                name: "IX_OfferProduct_ProductsId",
                table: "OfferProduct",
                column: "ProductsId");

            migrationBuilder.CreateIndex(
                name: "IX_Offers_CafeId",
                table: "Offers",
                column: "CafeId");
